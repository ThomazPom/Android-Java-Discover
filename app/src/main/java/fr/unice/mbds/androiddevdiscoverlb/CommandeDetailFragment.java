...
public class CommandeDetailFragment extends Fragment {
  ...
  //          mItem = DummyContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
            ...
            FloatingActionButton fab_delete_command = (FloatingActionButton) getActivity().findViewById(R.id.fab_delete_command);
            fab_delete_command.setOnClickListener(new View.OnClickListener() {

                @Override
                public void onClick(final View view) {
                    Commande.deleteCommande(myCommand.getIdcommande());
                                    Snackbar.make(view, "La commande a été supprimée", Snackbar.LENGTH_LONG)
            ...
            if (appBarLayout != null) {
                appBarLayout.setTitle("Detail: "+myCommand.getServeur().getPrenom()+" "+myCommand.getServeur().getNom());
            }
        }
    }
                ...
                public void onClick(final View v) {
                    ...
                    new CallAPI("http://95.142.161.35:8080/menu/"+myCommand.getIdcommande(),new CallAPI.CallbackClass() {
                        ...
                        public void postCall(JSONArray result) {
                            ...
                            Snackbar.make(v, "La commande est envoyée !", 4000)
                                    .setAction("Action", null).show();
                            adapter.plats.removeAll(adapter.plats);
